...
2. 如何创建datetime,date,time,timedelta对象?
   ...
   #常用的属性和函数
   date.min/max/year/month/day
   datetime.min/max/year/month/day/hour/minute/second/microsecend/tzinfo
...
文档链接如上，需要记住的是timedelta.min/max/days/seconds/microseconds属性
